 ...
 * @author CH-E00793
 */
public class getPackValidity extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            resMessage = cl.getDataPackValidity(strFlag, strMsisdn, circleId, strPackName, strSessionId);
            out.println("msg=" + resMessage);
        } catch (Exception e) {
            e.printStackTrace();
            resMessage = e.getMessage();
            Log.getRequestResponseReccStatusLog(strFlag, strSessionId + "," + strMsisdn + "," + circleId + "," + strPackName + "," + e.getMessage(), "Error");
